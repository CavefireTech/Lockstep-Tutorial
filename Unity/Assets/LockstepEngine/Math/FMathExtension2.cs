...
namespace Lockstep.Math {
    public static partial class FMathExtension {
        public static FVector2 ToLVector2(this FVector2Int vec){
            return new FVector2(true, vec.x * FP.Precision, vec.y * FP.Precision);
        }

        public static FVector3 ToLVector3(this FVector3Int vec){
        ...
        public static FVector3Int ToLVector3Int(this FVector3 vec){
